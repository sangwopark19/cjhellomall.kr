...
<aside>
	...
	<input type="hidden" name="qcaid" id="qcaid" value="<?php echo $qcaid ?>">
		<div class="search-box" style="padding-bottom:0px;">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label hidden-xs"><b>상품가격</b></label>
				<div class="col-sm-10">
					<label for="ssch_qfrom" class="sound_only">최소 가격</label>
					<label class="label-none">
						<input type="text" name="qfrom" value="<?php echo $qfrom; ?>" id="ssch_qfrom" class="form-control input-sm" size="12" placeholder="최소 가격">
					</label>
					<label> ~ </label>
					<label for="ssch_qto" class="sound_only">최대 가격</label>
					<label class="label-none">
						<input type="text" name="qto" value="<?php echo $qto; ?>" id="ssch_qto" class="form-control input-sm" size="12" placeholder="최대 가격">
					</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<div class="col-sm-6">
							<button type="submit" class="btn btn-<?php echo $sbtn;?> btn-block btn-sm search-btn"><i class="fa fa-search fa-lg"></i> 검색하기</button>
						</div>
					</div>
