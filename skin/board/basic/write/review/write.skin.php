...
?>
<div class="big-title">
	*신청하신 가입자님의 이름/연락처를 입력해주세요 (공개되지는 않습니다.)
</div>
<?php } ?>
<style>
	.big-title {font-size: 15px;margin: 16px 0 26px;}
	.form-horizontal .control-label {text-align: left;font-size: 14px;}
	.input-group {width: 100%;}
	.form-width {width: 100%;max-width: 200px;}
</style>
<!-- 게시물 작성/수정 시작 { -->
...
<?php if ($is_category || $option) { ?>
	<div class="form-group">
		<label class="col-sm-2 control-label hidden-xs"><?php echo ($is_category) ? '카테고리<span class="red">*</span>' : '옵션';?></label>
		<?php if ($is_category) { ?>
			<div class="col-sm-3">
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_subject">간단설명<span class="red">*</span><strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
...
<?php if ($is_file) { ?>
	<div class="form-group">
		<label class="col-sm-2 control-label hidden-xs">썸네일이미지<span class="red">*</span></label>
		<div class="col-sm-10">
...
<?php if ($is_name) { ?>
	<div class="form-group has-feedback">
		<label class="col-sm-2 control-label" for="wr_name">이름<span class="red">*</span><strong class="sound_only">필수</strong></label>
		<div class="col-sm-3">
			<input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="form-control input-sm form-width" size="10" maxlength="20">
...
<?php } ?>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="wr_1">연락처<span class="red">*</span></label>
		<div class="col-sm-10">
			<input type="text" name="wr_1" id="wr_1" value="<?php echo $write['wr_1']; ?>" class="form-control input-sm form-width" size="50">
		</div>
	</div>
	
<?php if ($is_password) { ?>
	<div class="form-group has-feedback">
		<label class="col-sm-2 control-label" for="wr_password">비밀번호<span class="red">*</span><strong class="sound_only">필수</strong></label>
		<div class="col-sm-3">
			<input type="password" name="wr_password" id="wr_password" <?php echo $password_required ?> class="form-control input-sm form-width" maxlength="20">
			<span class="fa fa-check form-control-feedback"></span>
		</div>
	</div>
<?php } ?>
