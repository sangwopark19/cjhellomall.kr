...
<?php } ?>
<?php
$sql = " SELECT as_good FROM g5_board_new WHERE bo_table='{$bo_table}' AND wr_id='{$wr_id}' ";
$res = sql_query($sql);
$new = mysqli_fetch_array($res);
?>
<div class="form-group has-feedback">
	<label class="col-sm-2 control-label" for="as_good">MD추천노출</label>
	<div class="col-sm-3">
		<input type="checkbox" name="as_good" id="as_good" <?php echo ( $new['as_good'] != 0 ) ? 'checked' : ''; ?> >
	</div>
</div>
<div class="form-group has-feedback">
	<label class="col-sm-2 control-label" for="wr_good">메인노출</label>
	<div class="col-sm-3">
		<input type="checkbox" name="wr_good" id="wr_good" <?php echo ( $write['wr_good'] != 0 ) ? 'checked' : ''; ?> >
	</div>
</div>
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_subject">상품 이름<strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_1">카드할인가</label>
	<div class="col-sm-10">
		<input type="text" name="wr_1" id="wr_1" value="<?php echo $write['wr_1']; ?>" class="form-control input-sm" size="50">
	</div>
</div>
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_3">현금사은품</label>
	<div class="col-sm-10">
		<input type="text" name="wr_3" id="wr_3" value="<?php echo $write['wr_3']; ?>" class="form-control input-sm" size="50">
	</div>
</div>
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_4">색상/모델명</label>
	<div class="col-sm-10">
		<input type="text" name="wr_4" id="wr_4" value="<?php echo $write['wr_4']; ?>" class="form-control input-sm" size="50">
	</div>
</div>
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_2">CJ렌탈가</label>
	<div class="col-sm-10">
		<input type="text" name="wr_2" id="wr_2" value="<?php echo $write['wr_2']; ?>" class="form-control input-sm" size="50">
	</div>
</div>
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_5">약정개월</label>
	<div class="col-sm-10">
		<input type="text" name="wr_5" id="wr_5" value="<?php echo $write['wr_5']; ?>" class="form-control input-sm" size="50">
	</div>
</div>
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_6">카드할인 내용</label>
	<div class="col-sm-10">
		<textarea name="wr_6" id="wr_6" value="<?php echo $write['wr_6']; ?>" class="text-box"><?php echo $write['wr_6']; ?></textarea>
	</div>
</div>
...
<?php if ($is_file) { ?>
	<div class="form-group" style="margin-bottom:0;">
		<label class="col-sm-2 control-label hidden-xs">썸네일 이미지</label>
		<div class="col-sm-10">
