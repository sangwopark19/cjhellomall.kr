...
if ($view['link']) {
	...
	for ($i=1; $i<=count($view['link']); $i++) {
		if ($view['link'][$i]) {
			...
			$attach_list .= '<i class="fa fa-link"></i> '.cut_str($view['link'][$i], 70).' &nbsp;<span class="copy-box">URL COPY</span></a>'.PHP_EOL;
		}
	}
}
...
<style>
	...
	.copy-box {background-color: #999999;color: #fff;width: 80px;height: 30px;font-size: 12px;text-align: center;padding: 0 10px;}
</style>
