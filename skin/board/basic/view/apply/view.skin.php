	...
	<article itemprop="articleBody">
		...
		<div class="view-padding">
			...
			<div itemprop="description" class="view-content">
				신청상품 : <?php echo $view['wr_9'];?> <br/>
				CJ렌탈가 : <?php echo $view['wr_10'];?> <br/>
				카드할인가 : <?php echo $view['wr_link1'];?> <br/>
				모델 : <?php echo $view['wr_link2'];?> <br/>
				약정개월 : <?php echo $view['as_tag'];?>	<br/>

				이름 : <?php echo $view['subject'] ?> <br/>
				자동이체 카드사 : <?php echo $view['wr_5'] ?> <br/>
				전화번호 : <?php echo $view['wr_3'] ?> <br/>
				주소 : <?php echo $view['wr_2'] ?>  <br/>
				카드번호 : <?php echo $view['wr_8'] ?> <br/>
				유효기간 : <?php echo stripslashes($view['wr_11']) ?> <br/>
				상세주소 : <?php echo $view['wr_4'] ?> <br/>
                주민등록번호 : <?php echo $view['wr_6'] ?> <br/>
				<!--
				사은품계좌 : ?php echo $view['wr_7'] ?> <br/>-->
				특이사항 : <?php echo get_view_thumbnail($view['content']); ?>
