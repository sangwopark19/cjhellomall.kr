...
$(document).ready(function(){
    var mainNavAll = $('.pc-menu .nav-full .menu-a').eq(0)
    var mainNavEach = $('.pc-menu .nav-full .menu-a');
    
    $()
//    mainNavAll .mouseenter(function(){
//
//    })
//    mainNavEach.mouseenter(function(){
