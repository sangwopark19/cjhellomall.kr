				...
				<div class="panel-group" id="switcherSet" role="tablist" aria-multiselectable="true">
					...
					<div class="panel">
						...
						<div id="swSet<?php echo $toggle;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="swHead<?php echo $toggle;?>">
							<div class="panel-body">
								<div class="text-muted ko-11 input-bottom">
									보드그룹/상품대분류 아이디를 콤마(,)구분 등록
								</div>

								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">제외메뉴</span>
									<input type="text" class="form-control input-sm" name="at_set[tmenu]" value="<?php echo $at_set['tmenu'];?>">
								</div>
								...
								<div class="input-group input-group-sm input-bottom">
									...
									<select id="nav-style" name="at_set[nav]" class="form-control">
										...
										<option value="mega"<?php echo get_selected('mega', $at_set['nav']);?>>메가</option>
										<option value="full"<?php echo get_selected('full', $at_set['nav']);?>>전체</option>
									</select>
								</div>
					...
					<div class="panel">
						<div class="panel-heading" role="tab" id="swHead<?php $toggle++; echo $toggle;?>" aria-expanded="true" aria-controls="swSet<?php echo $toggle;?>">
							<a data-toggle="collapse" data-parent="#switcherSet" href="#swSet<?php echo $toggle;?>">
								<i class="fa fa-caret-right"></i> 메뉴바 크기
							</a>
						</div>
						<div id="swSet<?php echo $toggle;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="swHead<?php echo $toggle;?>">
							<div class="panel-body">
								...
								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">전체높이</span>
									<input type="text" class="form-control input-sm" name="at_set[mph]" value="<?php echo $at_set['mph'];?>" placeholder="400">
									<span class="input-group-addon">px</span>
								</div>
					...
					<div class="panel">
						<div class="panel-heading" role="tab" id="swHead<?php $toggle++; echo $toggle;?>" aria-expanded="true" aria-controls="swSet<?php echo $toggle;?>">
							<a data-toggle="collapse" data-parent="#switcherSet" href="#swSet<?php echo $toggle;?>">
								<i class="fa fa-caret-right"></i> 컨텐츠 메뉴
							</a>
						</div>
						<div id="swSet<?php echo $toggle;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="swHead<?php echo $toggle;?>">
							<div class="panel-body">
								...
								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">출력메뉴</span>
									<input type="text" class="form-control input-sm" name="at_set[cmenu]" value="<?php echo $at_set['cmenu'];?>">
								</div>

								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">메뉴너비</span>
									<input type="text" class="form-control input-sm" name="at_set[cmw]" value="<?php echo $at_set['cmw'];?>" placeholder="170">
									<span class="input-group-addon">px</span>
								</div>

								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">메뉴높이</span>
									<input type="text" class="form-control input-sm" name="at_set[cmh]" value="<?php echo $at_set['cmh'];?>" placeholder="400">
									<span class="input-group-addon">px</span>
								</div>

								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">메뉴영역</span>
									<input type="text" class="form-control input-sm" name="at_set[cms]" value="<?php echo $at_set['cms'];?>" placeholder="860">
									<span class="input-group-addon">px</span>
								</div>
