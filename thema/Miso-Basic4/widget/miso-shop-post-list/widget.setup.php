...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td align="center">가로모드</td>
		<td>
			<select name="wset[garo]">
				<option value=""<?php echo get_selected('', $wset['garo']);?>>사용안함</option>
				<option value="1"<?php echo get_selected('1', $wset['garo']);?>>가로순 출력</option>
				<option value="2"<?php echo get_selected('2', $wset['garo']);?>>세로순 출력(더보기 적용안됨)</option>
			</select>
