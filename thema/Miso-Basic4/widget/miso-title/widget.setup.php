...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td align="center" rowspan="2">출력설정</td>
		<td>
			<?php echo help('네비위치는 기본 10px, 입력시 단위(px 또는 %)까지 입력.');?>
			...
			&nbsp;
			<label><input type="checkbox" name="wset[nav]" value="1"<?php echo get_checked('1', $wset['nav']);?>> 네비출력</label>
			-
			네비위치
